...
# -- Purple Scheme --
export BAR_COLOR=0xb3140c42 # with 70% transparency
# export BAR_COLOR=0xff021525
export ITEM_BG_COLOR=0xff2b1c84
export ACCENT_COLOR=0xffeb46f9 # magenta
# export ACCENT_COLOR=0x82aaffff # light blue-ish
